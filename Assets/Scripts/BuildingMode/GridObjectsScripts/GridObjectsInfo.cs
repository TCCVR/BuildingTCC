...
public class GridObjectsInfo :TInstantiableObjectInfo {
    ...
    public static GridObjectsInfo Create(Vector3 worldPosition, Constants.Dir dir, GridObjectsSO gridObjectSO, GameObject parent) {
    ...
    public void PlaceEdge(Constants.Dir edge, GridObjectsSO gridObjectSO, GameObject parent) {
